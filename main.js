...
function setupvalues(){
   ...
   gel("c_catspaceps").textContent = format(new Decimal(1.05).add(new Decimal(0.05).times(player.c_catup)).pow(new Decimal(1).divide(catspacesoftcat(player.c_catspace,player.c_meowup))),4)
   ...
   gel("c_cattime").textContent = format(player.c_catspacetime)
   gel("c_cattimemulti").textContent = "*"+format(cattimemulti(player.c_catspacetime))+" better upgrades"
